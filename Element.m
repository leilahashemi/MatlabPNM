classdef Element<Fluids
    ...
    methods
        ...
        function calculateConductance(obj,fluidViscosity)  
            % based on: Patzek, T. W., & Silin, D. B. (2001).  
            % we'd better to insert star shapes later
            if strcmp(obj.geometry , 'Triangle')== 1              
                obj.conductanceSinglePhase = 3 * obj.area^2 * obj.shapeFactor /fluidViscosity / 5; 
            elseif strcmp(obj.geometry , 'Square')== 1 
                obj.conductanceSinglePhase = 0.5623 * obj.area^2 * obj.shapeFactor /fluidViscosity; 
            else
                obj.conductanceSinglePhase = 0.5 * obj.area^2 * obj.shapeFactor /fluidViscosity; 
            end
        end
    end
