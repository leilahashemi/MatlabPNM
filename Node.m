classdef Node < Element
    ...
    methods
        ...
        function calculateThresholdPressurePoreBodyFilling_P (obj,network) 
         ...
         if z == 0
             obj.ThresholdPressure_PoreBodyFilling = nan;
         elseif z == 1
%              obj.calculateThresholdPressurePistonLike_Imbibition(network.Pc_drain_max);
            obj.ThresholdPressure_PoreBodyFilling = obj.ThresholdPressure_PistonLike;
         else            
            if z > 5
                w = W(6);
            else
             ...
             obj.ThresholdPressure_PoreBodyFilling = 2*obj.sig_ow/R_ave; 
         end        
        end
        %Blunt1
...
%              obj.calculateThresholdPressurePistonLike_Imbibition(network.Pc_drain_max);
            obj.ThresholdPressure_PoreBodyFilling = obj.ThresholdPressure_PistonLike;
             ...
             obj.ThresholdPressure_PoreBodyFilling = 2*obj.sig_ow * cos(obj.advancingContactAngle)/(obj.radius + nominator); 
         end        
        end
        %Blunt2
        function calculateThresholdPressurePoreBodyFilling_Blunt2 (obj,network)
         % Based on Blunt2
         obj.oilLayerExist(1,:) = nan;
         W =15000;
         attachedThroats = obj.connectedLinks;
...
%              obj.calculateThresholdPressurePistonLike_Imbibition(network.Pc_drain_max);
            ...
            nominator = 0;
             ...
             obj.ThresholdPressure_PoreBodyFilling = 2*obj.sig_ow * cos(obj.advancingContactAngle)/obj.radius - obj.sig_ow *nominator; 
        end
...
%              obj.calculateThresholdPressurePistonLike_Imbibition(network.Pc_drain_max);
            ...
            nominator = 0;
             ...
             obj.ThresholdPressure_PoreBodyFilling = (1 + 2 * sqrt(pi * obj.shapeFactor))*obj.sig_ow * cos(obj.advancingContactAngle)/...
